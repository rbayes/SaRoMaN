...
Run_CCTMVA::Run_CCTMVA(const bhep::gstore& store)
...
void Run_CCTMVA::set_MVA_methods(const bhep::gstore& store)
{
...
void Run_CCTMVA::define_cuts(const bhep::gstore& store){
...
/********************************************/
void Run_CCTMVA::define_variables(const bhep::gstore& store)
/********************************************/
{
...
void Run_CCTMVA::define_histograms(const bhep::gstore& store) {
...
void Run_CCTMVA::CreateHistogram(std::string Key, int ntBins, double* recEdge, double* trEdge, 
...
void Run_CCTMVA::FillHistogram(std::string Key, double Erec, double Etru,
...
/********************************************/
void Run_CCTMVA::plotEventTopology(int ifig, int imu, std::string method, 
...
/********************************************/
void Run_CCTMVA::define_rec_binning(const bhep::gstore& store, double* recB, double* truB)
/********************************************/
{
...
/********************************************/
{
  ...
  for (Long64_t ievt=0; ievt<theTree->GetEntries()-1;ievt++) {
    ...
    */
	...
	weight = _reader->EvaluateMVA( method+" method") ;
    ...
    for(int i=0; i<_myMethodList.size(); i++){
      ...
      weight = _reader->EvaluateMVA( method+" method") ;
      FillHistogram(method, recEng, nuEnergy, qP[imu], qPtru[0], weight, weightcut, truInt); 
      // Will not extract single events
      /*
...
/*******************************************/
bool Run_CCTMVA::PassQualityCuts()
/*******************************************/
{
...
/********************************************/
bool Run_CCTMVA::fiducial(double vx, double vy, double vz){
/********************************************/
...
/********************************************/
bool Run_CCTMVA::fiducial2(int nTraj) { 
/********************************************/
...
/********************************************/
bool Run_CCTMVA::pseudoTimeCut(std::vector<double> XPos,
