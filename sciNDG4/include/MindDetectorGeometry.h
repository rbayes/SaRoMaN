// ----------------------------------------------------------------------------
///  \file   MindDetectorGeometry.h
///  \brief  Definition of detector geometry.
///
///  \author   J Martin-Albo <jmalbos@ific.uv.es>
//   \date     14 Jun 2008
//   \version  $Id: MindDetectorGeometry.h 457 2011-09-07 17:20:21Z ryan $ 
//
...
//
class MindDetectorGeometry
{
public:
  /// Constructor
  MindDetectorGeometry();
  /// Destructor
  ~MindDetectorGeometry() {}
...
private:
  ...
  G4ThreeVector RandomPointInBox(G4double, G4double, G4double);
